...
cd /app
mkdir caddy
wget -P /app/caddy https://github.com/dos565689/NEW-IBMYes3/master/0915/caddy_v1.0.4_linux_amd64.tar.gz
...
wget -P /app/caddy https://github.com/dos565689/NEW-IBMYes3/master/0915/ngweb
wget -P /app/caddy https://github.com/dos565689/NEW-IBMYes3/master/0915/v2ctl
